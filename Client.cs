...
namespace StanzaApi.IataValidator
{
    public class IataValidatorClient
    {
        private readonly HttpClient _httpClient;
        private readonly string _apiKey;
        private readonly string _baseUrl;
        public string ToolUrl { get; } = "https://stanzaapi.com/tools/iata-validator";

        public IataValidatorClient(string apiKey = null, string baseUrl = null, HttpClient httpClient = null)
        {
            _apiKey = apiKey ?? Environment.GetEnvironmentVariable("STANZA_API_KEY") ?? Environment.GetEnvironmentVariable("API_KEY") ?? "";
            _baseUrl = (baseUrl ?? "https://api.stanzaapi.com/iata-validator").TrimEnd('/');
